package org.st412m.org.st412m.kotlincourse.lesson3
...
//Количество участников(изменяемое, числовое, целое)

//Длительность хакатона(неизменяемое, числовое, double)
...
//Информация о транспортировке оборудования, распределении ресурсов и координации между различными командами
